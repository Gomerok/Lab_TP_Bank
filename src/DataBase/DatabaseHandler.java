...
public class DatabaseHandler extends Configs {
    ...
    {
//        String insert;
//        insert = "INSERT INTO users(name,surname,login,password)VALUES(?,?,?,?)";
        System.out.println(Const.USER_TABLE);
                    String insert = "INSERT INTO "+Const.USER_TABLE+"("+Const.USERS_NAME +","+Const.USERS_SURNAME+","+Const.USERS_LOGIN+","+Const.USERS_PASSWORD+")"+"VALUES(?,?,?,?)";
